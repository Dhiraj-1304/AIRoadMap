        ...
        >
          ...
          <form onSubmit={handlesubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="email" className="text-xs font-semibold tracking-wider text-slate-400 uppercase">
                Email Address
              </label>
              <input
                id="email-address"
                ...
                required
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500/80 transition-all duration-200 sm:text-sm text-sm"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handlechange}
                  required
                  className="w-full px-4 py-3 pr-11 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500/80 transition-all duration-200 sm:text-sm text-sm"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 text-slate-400 cursor-pointer hover:text-white transition-colors">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/10 bg-white/5 text-purple-500 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-purple-500"
                />
          ...
          <div className="text-center mt-6 text-sm text-slate-400">
            ...
            <Link to="/register" className="text-purple-400 hover:text-purple-300 font-semibold ml-1.5 transition-colors">
              Create Account
            </Link>
          </div>
        </motion.div>
